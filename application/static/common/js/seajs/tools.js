...
define(function(require, exports, module) {
    ...
    var SizeClew = function(element, max, index, type) {
        var id = "clewTip" + index;
        var objClew = document.getElementById(id);
        var len = (type = type || 1)==1? element.value.len():element.value.length;
        if (objClew == null) {
        ...
        if (len > max) {
            ...
            objClew.innerHTML = "<b id='inFont' style='color:#D80000;'>" + len + "</b>/" + max;
        } else {
