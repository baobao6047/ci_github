/*! Sea.js 2.3.0 | seajs.org/LICENSE.md */ ! function(a, b) {
    ...
    if (!a.seajs) {
        var t = a.seajs = { version: "2.3.0" },
            ...
            z = 0,
            A = u.events = {};
        t.on = function(a, b) { var c = A[a] || (A[a] = []); return c.push(b), t }, t.off = function(a, b) {
        ...
        var B = t.emit = function(a, b) {
                var c = A[a],
                    d;
                if (c) { c = c.slice(); for (var e = 0, f = c.length; f > e; e++) c[e](b) }
                return t
            },
            C = /[^?#]*\//,
            D = /\/\.\//g,
        ...
        s.prototype.resolve = function() { for (var a = this, b = a.dependencies, c = [], d = 0, e = b.length; e > d; d++) c[d] = s.resolve(b[d], a.uri); return c }, s.prototype.load = function() {
            var a = this;
            if (!(a.status >= $.LOADING)) {
                a.status = $.LOADING;
                var c = a.resolve();
            ...
            function d() { delete X[h], Y[h] = !0, W && (s.save(f, W), W = null); var a, b = Z[h]; for (delete Z[h]; a = b.shift();) a.load() }
            var e = this,
                f = e.uri;
            e.status = $.FETCHING;
            var g = { uri: f };
            ...
            c.status = $.EXECUTING;
            var e = c.uri;
            a.resolve = function(a) { return s.resolve(a, e) }, a.async = function(b, c) { return s.use(b, c, e + "_async_" + d()), a };
            var f = c.factory,
                g = y(f) ? f(a, c.exports = {}, c) : f;
            return g === b && (g = c.exports), delete c.factory, c.exports = g, c.status = $.EXECUTED, B("exec", c), g
        }, s.resolve = function(a, b) { var c = { id: a, refUri: b }; return B("resolve", c), c.uri || t.resolve(c.id, b) }, s.define = function(a, c, d) {
        ...
        }, s.get = function(a, b) { return V[a] || (V[a] = new s(a, b)) }, s.use = function(b, c, d) {
            var e = s.get(d, x(b) ? b : [b]);
            e.callback = function() {
                for (var b = [], d = e.resolve(), f = 0, g = d.length; g > f; f++) b[f] = V[d[f]].exec();
                c && c.apply(a, b), delete e.callback
            }, e.load()
        }, t.use = function(a, b) { return s.use(a, b, u.cwd + "_use_" + d()), t }, s.define.cmd = {}, a.define = s.define, t.Module = s, u.fetchedList = Y, u.cid = d, t.require = function(a) { var b = s.get(s.resolve(a)); return b.status < $.EXECUTING && (b.onload(), b.exec()), b.exports }, u.base = O, u.dir = O, u.cwd = L, u.charset = "utf-8", t.config = function(a) {
            for (var b in a) {
                var c = a[b],
                    d = u[b];
                if (d && v(d))
...
//eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('4.f({d:\'o://l.\'+i.k.j.n(\'.\')[1]+\'.m/\',e:{\'6\':\'2/0/4/c\',\'7\':\'2/0/4/7\',\'h\':\'2/0/4/g\',\'5\':\'2/0/4/5.w\',\'y\':\'2/0/4/6.x\',\'z\':\'2/0/4/B\',\'A\':\'2/0/4/r\',\'8\':\'2/0/4/8\',\'9\':\'2/0/4/9\',\'a\':\'2/0/4/a\',\'q\':\'2/0/4/p\',\'b\':\'2/0/4/b\',\'s\':\'2/0/v/u.3.t\'}});',38,38,'js||common||seajs|laydate|jquery|dialog|uploadPreview|cb_all|mathacc|count_down|seajquery|base|alias|config|top_banner|topBanner|window|href|location|static|com|split|http|tools|SizeClew|ybglobal|Validform|2_sea|Validform_v5|validform|dev|form|jQform|ybadaptive|global|yb_adaptive'.split('|'),0,{}))

var _host = window.location.host;
var _url = _host.substr(_host.indexOf('.') + 1, _host.length) + '/';
...
seajs.config({
    ...
    alias: {
        ...
        'global': 'common/js/seajs/ybglobal123123123',
        ...
        'jQprint': 'common/js/seajs/jquery.printThis',
        'jQtimepicker': 'common/js/seajs/jquery.timepicker',
        'JQzoom': 'common/js/seajs/jqueryzoom',
        'tools': 'common/js/seajs/tools',
        'vailForm': 'common/js/seajs/vailForm',
        'search': 'common/js/seajs/search',
        'z_dialog': 'common/js/seajs/z_dialog',
        'citySelect': 'common/js/seajs/citySelect',
        'webuploader': 'common/js/webuploader/webuploader',
        'uploaderutil': 'common/js/seajs/uploaderUtil',
        'kindeditor': 'common/js/kindeditor/kindeditor-all',
        'region': 'common/js/seajs/jquery.region',
        'share': 'common/js/seajs/share',
        'utilsAdmin': 'system/js/public/public'
    }
});